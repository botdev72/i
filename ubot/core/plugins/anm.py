...
async def ls(client, message):
    await message.reply(
        ...
        "├ Up View CH\n"
        "├ Up Member GC\n"
        "└ Up Followers IG dan Kebutuhan Social Media Lainnya\n",
    )

async def pay(client, message):
    await message.reply(
        "❏ SMM-PEDIA PAYMENT\n"
        "OVO : <code>083821362840</code>\n"
        "DANA : <code>083821362840</code>\n"
        "GOPAY : <code>081511073726</code>\n"
        "BCA : <code>1393392073</code>\n"
        "QRIS : <a href=https://t.me/qrispunyazull/2>klik</a>\n"
        "LinkAja : <code>083821362840</code>\n"
        "Pembayaran A.N BAYU RIZKI ZULFIKRI\n",
    )
